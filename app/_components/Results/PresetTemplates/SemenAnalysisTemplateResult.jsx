...
function SemenAnalysisTemplateResult({ template }) {
  return (
    <div
      className="flex flex-col  gap-6 w-full h-[80%] px-2 overflow-hidden"
      dir="ltr"
    >
  ...
  return (
    <div className="flex gap-1 items-start justify-center">
      <div className="flex flex-col items-center gap-0.5">
        ...
        <span>{englishName} </span>
        <span
          className="w-[15ch] text-white text-center py-1 bg-light_primary rounded h-fit "
          dir="ltr"
        >
...
export default SemenAnalysisTemplateResult;
